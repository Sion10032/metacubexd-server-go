...
type Tab interface {
	...
	Update(msg tea.Msg) (Tab, tea.Cmd, bool) // handle messages routed to this page, return the new tab + side effects + whether the message was consumed
...
// IsScrollKey reports whether the key scrolls a viewport (PgUp/PgDn/up/down).
