...
func TestConnectionClose(t *testing.T) {
	msg := ConnectionsLoadedMsg{
		Resp: client.ConnectionsResponse{
			Connections: []client.Connection{
				{ID: "conn1", Metadata: client.ConnectionMetadata{Host: "example.com"}},
			},
		},
	}
	...
	msg := ConnectionsLoadedMsg{
		Resp: client.ConnectionsResponse{
			Connections: []client.Connection{
				{
					ID:       "conn1",
					Metadata: client.ConnectionMetadata{DestinationIP: "93.184.216.34", DestinationPort: "80"},
				},
			},
		},
	}
...
func TestConnectionsCursor(t *testing.T) {
	msg := ConnectionsLoadedMsg{
		Resp: client.ConnectionsResponse{
			Connections: []client.Connection{
				{ID: "conn1", Metadata: client.ConnectionMetadata{Host: "example.com"}},
				{ID: "conn2", Metadata: client.ConnectionMetadata{Host: "google.com"}},
			},
		},
	}
